...
module.exports = cds.service.impl(function () {
    ...
    this.on('createProductComplaintMdk', async (req) => {
        try{
        ...
        var PprHeader = JSON.parse(req.data.PprHeader);
        var PprAttachment = JSON.parse(req.data.PprAttachment);
        var PprEvent = JSON.parse(req.data.PprEvent);
