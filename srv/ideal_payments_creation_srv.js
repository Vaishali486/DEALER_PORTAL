...
module.exports = cds.service.impl(function () {
    ...
    this.on('createPaymentMDK', async (req) => {
        try{
        ...
        var paymentsHeader = JSON.parse(req.data.paymentsHeader);
        var paymentsAttachments = JSON.parse(req.data.paymentsAttachments);
        var paymentsEventLog = JSON.parse(req.data.paymentsEventLog);
        ...
        if(sAction === 'CREATE')
        {
            ...
            sResponse = await dbConn.callProcedurePromisified(loadProc,[sAction,null,vDistributorId,paymentsHeader,paymentsAttachmentsObj,paymentsEventLog,checkApprover[0].LEVEL,checkApprover[0].ROLE_CODE]);
            Result = sResponse.outputScalar.OUT_SUCCESS;
            var PayReqNo = sResponse.outputScalar.OUT_SUCCESS; //
            ...
            if (sResponse.outputScalar.OUT_SUCCESS !== null) {     
                ...
                // Result =  "Payment Request Created : " + sResponse.outputScalar.OUT_SUCCESS || "";
                Result = sResponse.outputScalar.OUT_SUCCESS;
                // Result = 123;
                // Result = {
                //     OUT_SUCCESS: "Payment Request Created : " + sResponse.outputScalar.OUT_SUCCESS || ""
        ...
        {   
            ...
            return sResponse.outputScalar.OUT_SUCCESS;
        }
        else if(sAction === 'SENDBACK'){
